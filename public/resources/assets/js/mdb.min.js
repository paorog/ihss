...
/******/{
	...
	/***/function _(module, exports, __webpack_require__) {
		...
		/* WEBPACK VAR INJECTION */(function (global) {
			var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_RESULT__;var require;var require;var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, { def: "easeOutQuad", swing: function swing(t, e, n, i, a) {
					return jQuery.easing[jQuery.easing.def](t, e, n, i, a);
				}, easeInQuad: function easeInQuad(t, e, n, i, a) {
					return i * (e /= a) * e + n;
				}, easeOutQuad: function easeOutQuad(t, e, n, i, a) {
					return -i * (e /= a) * (e - 2) + n;
				}, easeInOutQuad: function easeInOutQuad(t, e, n, i, a) {
					return (e /= a / 2) < 1 ? i / 2 * e * e + n : -i / 2 * (--e * (e - 2) - 1) + n;
				}, easeInCubic: function easeInCubic(t, e, n, i, a) {
					return i * (e /= a) * e * e + n;
				}, easeOutCubic: function easeOutCubic(t, e, n, i, a) {
					return i * ((e = e / a - 1) * e * e + 1) + n;
				}, easeInOutCubic: function easeInOutCubic(t, e, n, i, a) {
					return (e /= a / 2) < 1 ? i / 2 * e * e * e + n : i / 2 * ((e -= 2) * e * e + 2) + n;
				}, easeInQuart: function easeInQuart(t, e, n, i, a) {
					return i * (e /= a) * e * e * e + n;
				}, easeOutQuart: function easeOutQuart(t, e, n, i, a) {
					return -i * ((e = e / a - 1) * e * e * e - 1) + n;
				}, easeInOutQuart: function easeInOutQuart(t, e, n, i, a) {
					return (e /= a / 2) < 1 ? i / 2 * e * e * e * e + n : -i / 2 * ((e -= 2) * e * e * e - 2) + n;
				}, easeInQuint: function easeInQuint(t, e, n, i, a) {
					return i * (e /= a) * e * e * e * e + n;
				}, easeOutQuint: function easeOutQuint(t, e, n, i, a) {
					return i * ((e = e / a - 1) * e * e * e * e + 1) + n;
				}, easeInOutQuint: function easeInOutQuint(t, e, n, i, a) {
					return (e /= a / 2) < 1 ? i / 2 * e * e * e * e * e + n : i / 2 * ((e -= 2) * e * e * e * e + 2) + n;
				}, easeInSine: function easeInSine(t, e, n, i, a) {
					return -i * Math.cos(e / a * (Math.PI / 2)) + i + n;
				}, easeOutSine: function easeOutSine(t, e, n, i, a) {
					return i * Math.sin(e / a * (Math.PI / 2)) + n;
				}, easeInOutSine: function easeInOutSine(t, e, n, i, a) {
					return -i / 2 * (Math.cos(Math.PI * e / a) - 1) + n;
				}, easeInExpo: function easeInExpo(t, e, n, i, a) {
					return 0 == e ? n : i * Math.pow(2, 10 * (e / a - 1)) + n;
				}, easeOutExpo: function easeOutExpo(t, e, n, i, a) {
					return e == a ? n + i : i * (1 - Math.pow(2, -10 * e / a)) + n;
				}, easeInOutExpo: function easeInOutExpo(t, e, n, i, a) {
					return 0 == e ? n : e == a ? n + i : (e /= a / 2) < 1 ? i / 2 * Math.pow(2, 10 * (e - 1)) + n : i / 2 * (2 - Math.pow(2, -10 * --e)) + n;
				}, easeInCirc: function easeInCirc(t, e, n, i, a) {
					return -i * (Math.sqrt(1 - (e /= a) * e) - 1) + n;
				}, easeOutCirc: function easeOutCirc(t, e, n, i, a) {
					return i * Math.sqrt(1 - (e = e / a - 1) * e) + n;
				}, easeInOutCirc: function easeInOutCirc(t, e, n, i, a) {
					return (e /= a / 2) < 1 ? -i / 2 * (Math.sqrt(1 - e * e) - 1) + n : i / 2 * (Math.sqrt(1 - (e -= 2) * e) + 1) + n;
				}, easeInElastic: function easeInElastic(t, e, n, i, a) {
					var r = 1.70158,
					    o = 0,
					    s = i;if (0 == e) return n;if (1 == (e /= a)) return n + i;if (o || (o = .3 * a), s < Math.abs(i)) {
						s = i;var r = o / 4;
					} else var r = o / (2 * Math.PI) * Math.asin(i / s);return -(s * Math.pow(2, 10 * (e -= 1)) * Math.sin((e * a - r) * (2 * Math.PI) / o)) + n;
				}, easeOutElastic: function easeOutElastic(t, e, n, i, a) {
					var r = 1.70158,
					    o = 0,
					    s = i;if (0 == e) return n;if (1 == (e /= a)) return n + i;if (o || (o = .3 * a), s < Math.abs(i)) {
						s = i;var r = o / 4;
					} else var r = o / (2 * Math.PI) * Math.asin(i / s);return s * Math.pow(2, -10 * e) * Math.sin((e * a - r) * (2 * Math.PI) / o) + i + n;
				}, easeInOutElastic: function easeInOutElastic(t, e, n, i, a) {
					var r = 1.70158,
					    o = 0,
					    s = i;if (0 == e) return n;if (2 == (e /= a / 2)) return n + i;if (o || (o = a * (.3 * 1.5)), s < Math.abs(i)) {
						s = i;var r = o / 4;
					} else var r = o / (2 * Math.PI) * Math.asin(i / s);return e < 1 ? -.5 * (s * Math.pow(2, 10 * (e -= 1)) * Math.sin((e * a - r) * (2 * Math.PI) / o)) + n : s * Math.pow(2, -10 * (e -= 1)) * Math.sin((e * a - r) * (2 * Math.PI) / o) * .5 + i + n;
				}, easeInBack: function easeInBack(t, e, n, i, a, r) {
					return void 0 == r && (r = 1.70158), i * (e /= a) * e * ((r + 1) * e - r) + n;
				}, easeOutBack: function easeOutBack(t, e, n, i, a, r) {
					return void 0 == r && (r = 1.70158), i * ((e = e / a - 1) * e * ((r + 1) * e + r) + 1) + n;
				}, easeInOutBack: function easeInOutBack(t, e, n, i, a, r) {
					return void 0 == r && (r = 1.70158), (e /= a / 2) < 1 ? i / 2 * (e * e * ((1 + (r *= 1.525)) * e - r)) + n : i / 2 * ((e -= 2) * e * ((1 + (r *= 1.525)) * e + r) + 2) + n;
				}, easeInBounce: function easeInBounce(t, e, n, i, a) {
					return i - jQuery.easing.easeOutBounce(t, a - e, 0, i, a) + n;
				}, easeOutBounce: function easeOutBounce(t, e, n, i, a) {
				...
				}, easeInOutBounce: function easeInOutBounce(t, e, n, i, a) {
				...
				function e(t) {
					...
					var n = function n(t, e) {
						...
						var a = 0,
						    r = t.length,
						    o = e(t);if (i) {
							if (o) for (; r > a && n.apply(t[a], i) !== !1; a++) {} else for (a in t) {
								if (n.apply(t[a], i) === !1) break;
							}
						} else if (o) for (; r > a && n.call(t[a], a, t[a]) !== !1; a++) {} else for (a in t) {
							if (n.call(t[a], a, t[a]) === !1) break;
						}return t;
					}, n.data = function (t, e, a) {
						if (void 0 === a) {
							var r = t[n.expando],
							    o = r && i[r];if (void 0 === e) return o;if (o && e in o) return o[e];
						} else if (void 0 !== e) {
							var r = t[n.expando] || (t[n.expando] = ++n.uuid);return i[r] = i[r] || {}, i[r][e] = a, a;
						}
					}, n.removeData = function (t, e) {
						var a = t[n.expando],
						    r = a && i[a];r && n.each(e, function (t, e) {
							delete r[e];
						});
					}, n.extend = function () {
						var t,
						    ...
						    l = 1,
						    u = arguments.length,
						    d = !1;for ("boolean" == typeof s && (d = s, s = arguments[l] || {}, l++), "object" != (typeof s === 'undefined' ? 'undefined' : _typeof(s)) && "function" !== n.type(s) && (s = {}), l === u && (s = this, l--); u > l; l++) {
							if (null != (r = arguments[l])) for (a in r) {
								t = s[a], i = r[a], s !== i && (d && i && (n.isPlainObject(i) || (e = n.isArray(i))) ? (e ? (e = !1, o = t && n.isArray(t) ? t : []) : o = t && n.isPlainObject(t) ? t : {}, s[a] = n.extend(d, o, i)) : void 0 !== i && (s[a] = i));
							}
						}return s;
					}, n.queue = function (t, i, a) {
						if (t) {
							i = (i || "fx") + "queue";var r = n.data(t, i);return a ? (!r || n.isArray(a) ? r = n.data(t, i, function (t, n) {
								var i = n || [];return null != t && (e(Object(t)) ? function (t, e) {
									for (var n = +e.length, i = 0, a = t.length; n > i;) {
										t[a++] = e[i++];
						...
						n.each(t.nodeType ? [t] : t, function (t, i) {
							e = e || "fx";var a = n.queue(i, e),
							    r = a.shift();"inprogress" === r && (r = a.shift()), r && ("fx" === e && a.unshift("inprogress"), r.call(i, function () {
								n.dequeue(i, e);
							}));
						});
							...
							function t() {
							    ...
							    t = t.apply(e),
							    i = this.offset(),
							    a = /^(?:body|html)$/i.test(t.nodeName) ? { top: 0, left: 0 } : n(t).offset();return i.top -= parseFloat(e.style.marginTop) || 0, i.left -= parseFloat(e.style.marginLeft) || 0, t.style && (a.top += parseFloat(t.style.borderTopWidth) || 0, a.left += parseFloat(t.style.borderLeftWidth) || 0), { top: i.top - a.top, left: i.left - a.left };
						} };var i = {};n.expando = "velocity" + new Date().getTime(), n.uuid = 0;for (var a = {}, r = a.hasOwnProperty, o = a.toString, s = "Boolean Number String Function Array Date RegExp Object Error".split(" "), l = 0; l < s.length; l++) {
						a["[object " + s[l] + "]"] = s[l].toLowerCase();
					}n.fn.init.prototype = n.fn, t.Velocity = { Utilities: n };
				}
			}(window), function (t) {
				"object" == (typeof module === 'undefined' ? 'undefined' : _typeof(module)) && "object" == _typeof(module.exports) ? module.exports = t() : true ? !(__WEBPACK_AMD_DEFINE_FACTORY__ = t, __WEBPACK_AMD_DEFINE_RESULT__ = typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? __WEBPACK_AMD_DEFINE_FACTORY__.call(exports, __webpack_require__, exports, module) : __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : t();
			}(function () {
				return function (t, e, n, i) {
					function a(t) {
						for (var e = -1, n = t ? t.length : 0, i = []; ++e < n;) {
							var a = t[e];a && i.push(a);
						}return i;
					}function r(t) {
						...
						function r(t, e) {
							...
							for (var a = 0; g > a; ++a) {
								var r = u(n, t, i);if (0 === r) return n;n -= (l(n, t, i) - e) / r;
							}return n;
						}function c() {
							for (var e = 0; y > e; ++e) {
								S[e] = l(e * x, t, i);
							...
							} while (Math.abs(r) > v && ++s < b);return o;
						}function f(e) {
							for (var n = 0, a = 1, r = y - 1; a != r && S[a] <= e; ++a) {
								n += x;
							}--a;var o = (e - S[a]) / (S[a + 1] - S[a]),
							    s = n + o * x,
						...
						};var P = "generateBezier(" + [t, n, i, a] + ")";return M.toString = function () {
							return P;
						}, M;
					}function u(t, e) {
						var n = t;return g.isString(t) ? y.Easings[t] || (n = !1) : n = g.isArray(t) && 1 === t.length ? s.apply(null, t) : g.isArray(t) && 2 === t.length ? x.apply(null, t.concat([e])) : !(!g.isArray(t) || 4 !== t.length) && l.apply(null, t), n === !1 && (n = y.Easings[y.defaults.easing] ? y.defaults.easing : b), n;
					}function d(t) {
						if (t) {
							var e = new Date().getTime(),
							    n = y.State.calls.length;n > 1e4 && (y.State.calls = a(y.State.calls));for (var r = 0; n > r; r++) {
								if (y.State.calls[r]) {
									var s = y.State.calls[r],
									    ...
									    f = s[3],
									    p = !!f,
									    m = null;f || (f = y.State.calls[r][3] = e - 16);for (var v = Math.min((e - f) / u.duration, 1), b = 0, x = l.length; x > b; b++) {
										var k = l[b],
										    C = k.element;if (o(C)) {
											var M = !1;if (u.display !== i && null !== u.display && "none" !== u.display) {
												if ("flex" === u.display) {
													var P = ["-webkit-box", "-moz-box", "-ms-flexbox", "-webkit-flex"];h.each(P, function (t, e) {
														w.setPropertyValue(C, "display", e);
													});
												}w.setPropertyValue(C, "display", u.display);
											}u.visibility !== i && "hidden" !== u.visibility && w.setPropertyValue(C, "visibility", u.visibility);for (var A in k) {
												if ("element" !== A) {
													var I,
													    _ = k[A],
													    T = g.isString(_.easing) ? y.Easings[_.easing] : _.easing;if (1 === v) I = _.endValue;else {
														var D = _.endValue - _.startValue;if (I = _.startValue + D * T(v, u, D), !p && I === _.currentValue) continue;
													}if (_.currentValue = I, "tween" === A) m = I;else {
														if (w.Hooks.registered[A]) {
															var V = w.Hooks.getRoot(A),
															    F = o(C).rootPropertyValueCache[V];F && (_.rootPropertyValue = F);
														}var L = w.setPropertyValue(C, A, _.currentValue + (0 === parseFloat(I) ? "" : _.unitType), _.rootPropertyValue, _.scrollData);w.Hooks.registered[A] && (o(C).rootPropertyValueCache[V] = w.Normalizations.registered[V] ? w.Normalizations.registered[V]("extract", null, L[1]) : L[1]), "transform" === L[0] && (M = !0);
													}
												}
						...
						if (!y.State.calls[t]) return !1;for (var n = y.State.calls[t][0], a = y.State.calls[t][1], r = y.State.calls[t][2], s = y.State.calls[t][4], l = !1, u = 0, d = n.length; d > u; u++) {
							var c = n[u].element;if (e || r.loop || ("none" === r.display && w.setPropertyValue(c, "display", r.display), "hidden" === r.visibility && w.setPropertyValue(c, "visibility", r.visibility)), r.loop !== !0 && (h.queue(c)[1] === i || !/\.velocityQueueEntryFlag/i.test(h.queue(c)[1])) && o(c)) {
								o(c).isAnimating = !1, o(c).rootPropertyValueCache = {};var f = !1;h.each(w.Lists.transforms3D, function (t, e) {
									var n = /^scale/.test(e) ? 1 : 0,
									    a = o(c).transformCache[e];o(c).transformCache[e] !== i && new RegExp("^\\(" + n + "[^.]").test(a) && (f = !0, delete o(c).transformCache[e]);
							...
							}), y(c, "reverse", { loop: !0, delay: r.delay })), r.queue !== !1 && h.dequeue(c, r.queue);
					    ...
					    b = "swing",
					    y = { State: { isMobile: /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent), isAndroid: /Android/i.test(navigator.userAgent), isGingerbread: /Android 2\.3\.[3-7]/i.test(navigator.userAgent), isChrome: e.chrome, isFirefox: /Firefox/i.test(navigator.userAgent), prefixElement: n.createElement("div"), prefixMatches: {}, scrollAnchor: null, scrollPropertyLeft: null, scrollPropertyTop: null, isTicking: !1, calls: [] }, CSS: {}, Utilities: h, Redirects: {}, Easings: {}, Promise: e.Promise, defaults: { queue: "", duration: v, easing: b, begin: i, complete: i, progress: i, display: i, visibility: i, loop: !1, delay: !1, mobileHA: !0, _cacheValues: !0 }, init: function init(t) {
							h.data(t, "velocity", { isSVG: g.isSVG(t), isAnimating: !1, computedStyle: null, tweensContainer: null, rootPropertyValueCache: {}, transformCache: {} });
						}, hook: null, mock: !1, version: { major: 1, minor: 2, patch: 2 }, debug: !1 };e.pageYOffset !== i ? (y.State.scrollAnchor = e, y.State.scrollPropertyLeft = "pageXOffset", y.State.scrollPropertyTop = "pageYOffset") : (y.State.scrollAnchor = n.documentElement || n.body.parentNode || n.body, y.State.scrollPropertyLeft = "scrollLeft", y.State.scrollPropertyTop = "scrollTop");var x = function () {
						function t(t) {
							return -t.tension * t.x - t.friction * t.v;
						}function e(e, n, i) {
							var a = { x: e.x + i.dx * n, v: e.v + i.dv * n, tension: e.tension, friction: e.friction };return { dx: a.v, dv: t(a) };
						}function n(n, i) {
							var a = { dx: n.v, dv: t(n) },
							    r = e(n, .5 * i, a),
							    o = e(n, .5 * i, r),
							    ...
							    u = 1 / 6 * (a.dv + 2 * (r.dv + o.dv) + s.dv);return n.x = n.x + l * i, n.v = n.v + u * i, n;
							...
							var r,
							    ...
							    u = [0],
							    d = 0;for (e = parseFloat(e) || 500, i = parseFloat(i) || 20, a = a || null, l.tension = e, l.friction = i, r = null !== a, r ? (d = t(e, i), o = d / a * .016) : o = .016; s = n(s || l, o), u.push(1 + s.x), d += 16, Math.abs(s.x) > 1e-4 && Math.abs(s.v) > 1e-4;) {}return r ? function (t) {
								return u[t * (u.length - 1) | 0];
							} : d;
						};
					}();y.Easings = { linear: function linear(t) {
							return t;
						...
						y.Easings[e[0]] = l.apply(null, e[1]);
								...
								}var n, i, a;if (f) for (n in w.Hooks.templates) {
									i = w.Hooks.templates[n], a = i[0].split(" ");var r = i[1].match(w.RegEx.valueSplit);"Color" === a[0] && (a.push(a.shift()), r.push(r.shift()), w.Hooks.templates[n] = [a.join(" "), r.join(" ")]);
								}for (n in w.Hooks.templates) {
									i = w.Hooks.templates[n], a = i[0].split(" ");for (var t in a) {
										var o = n + a[t],
										    s = t;w.Hooks.registered[o] = [n, s];
									}
								}
								...
								var n = w.Hooks.registered[t];if (n) {
									var i = n[0],
									    a = n[1];return e = w.Hooks.cleanRootPropertyValue(i, e), e.toString().match(w.RegEx.valueSplit)[a];
								}return e;
							}, injectValue: function injectValue(t, e, n) {
								var i = w.Hooks.registered[t];if (i) {
									var a,
									    r = i[0],
									    o = i[1];return n = w.Hooks.cleanRootPropertyValue(r, n), a = n.toString().match(w.RegEx.valueSplit), a[o] = e, a.join(" ");
								}return n;
									...
									switch (t) {case "name":
											...
											var i = parseFloat(n);if (!i && 0 !== i) {
												var a = n.toString().match(/blur\(([0-9]+[A-z]+)\)/i);i = a ? a[1] : 0;
											}return i;case "inject":
											return parseFloat(n) ? "blur(" + n + ")" : "none";}
								}, opacity: function opacity(t, e, n) {
									if (8 >= f) switch (t) {case "name":
								...
								9 >= f || y.State.isGingerbread || (w.Lists.transformsBase = w.Lists.transformsBase.concat(w.Lists.transforms3D));for (var t = 0; t < w.Lists.transformsBase.length; t++) {
									!function () {
										var e = w.Lists.transformsBase[t];w.Normalizations.registered[e] = function (t, n, a) {
											switch (t) {case "name":
													return "transform";case "extract":
													return o(n) === i || o(n).transformCache[e] === i ? /^scale/i.test(e) ? 1 : 0 : o(n).transformCache[e].replace(/[()]/g, "");case "inject":
													var r = !1;switch (e.substr(0, e.length - 1)) {case "translate":
															r = !/(%|px|em|rem|vw|vh|\d)$/i.test(a);break;case "scal":case "scale":
															y.State.isAndroid && o(n).transformCache[e] === i && 1 > a && (a = 1), r = !/(\d)$/i.test(a);break;case "skew":
															r = !/(deg|\d)$/i.test(a);break;case "rotate":
															r = !/(deg|\d)$/i.test(a);}return r || (o(n).transformCache[e] = "(" + a + ")"), o(n).transformCache[e];}
										};
									}();
								}for (var t = 0; t < w.Lists.colors.length; t++) {
									!function () {
										var e = w.Lists.colors[t];w.Normalizations.registered[e] = function (t, n, a) {
											switch (t) {case "name":
													return e;case "extract":
													var r;if (w.RegEx.wrappedValueAlreadyExtracted.test(a)) r = a;else {
														var o,
														    s = { black: "rgb(0, 0, 0)", blue: "rgb(0, 0, 255)", gray: "rgb(128, 128, 128)", green: "rgb(0, 128, 0)", red: "rgb(255, 0, 0)", white: "rgb(255, 255, 255)" };/^[A-z]+$/i.test(a) ? o = s[a] !== i ? s[a] : s.black : w.RegEx.isHex.test(a) ? o = "rgb(" + w.Values.hexToRgb(a).join(" ") + ")" : /^rgba?\(/i.test(a) || (o = s.black), r = (o || a).toString().match(w.RegEx.valueUnwrap)[1].replace(/,(\s+)?/g, " ");
													}return 8 >= f || 3 !== r.split(" ").length || (r += " 1"), r;case "inject":
								...
								var e = "width|height|x|y|cx|cy|r|rx|ry|x1|x2|y1|y2";return (f || y.State.isAndroid && !y.State.isChrome) && (e += "|transform"), new RegExp("^(" + e + ")$", "i").test(t);
							}, prefixCheck: function prefixCheck(t) {
								if (y.State.prefixMatches[t]) return [y.State.prefixMatches[t], !0];for (var e = ["", "Webkit", "Moz", "ms", "O"], n = 0, i = e.length; i > n; n++) {
									var a;if (a = 0 === n ? t : e[n] + t.replace(/^\w/, function (t) {
							...
							} }, getPropertyValue: function getPropertyValue(t, n, a, r) {
							function s(t, n) {
								function a() {
									u && w.setPropertyValue(t, "display", "none");
								}var l = 0;if (8 >= f) l = h.css(t, n);else {
									var u = !1;if (/^(width|height)$/.test(n) && 0 === w.getPropertyValue(t, "display") && (u = !0, w.setPropertyValue(t, "display", w.Values.getDisplayType(t))), !r) {
										if ("height" === n && "border-box" !== w.getPropertyValue(t, "boxSizing").toString().toLowerCase()) {
											var d = t.offsetHeight - (parseFloat(w.getPropertyValue(t, "borderTopWidth")) || 0) - (parseFloat(w.getPropertyValue(t, "borderBottomWidth")) || 0) - (parseFloat(w.getPropertyValue(t, "paddingTop")) || 0) - (parseFloat(w.getPropertyValue(t, "paddingBottom")) || 0);return a(), d;
										}if ("width" === n && "border-box" !== w.getPropertyValue(t, "boxSizing").toString().toLowerCase()) {
											var c = t.offsetWidth - (parseFloat(w.getPropertyValue(t, "borderLeftWidth")) || 0) - (parseFloat(w.getPropertyValue(t, "borderRightWidth")) || 0) - (parseFloat(w.getPropertyValue(t, "paddingLeft")) || 0) - (parseFloat(w.getPropertyValue(t, "paddingRight")) || 0);return a(), c;
										}
									}var p;p = o(t) === i ? e.getComputedStyle(t, null) : o(t).computedStyle ? o(t).computedStyle : o(t).computedStyle = e.getComputedStyle(t, null), "borderColor" === n && (n = "borderTopColor"), l = 9 === f && "filter" === n ? p.getPropertyValue(n) : p[n], ("" === l || null === l) && (l = t.style[n]), a();
								}if ("auto" === l && /^(top|right|bottom|left)$/i.test(n)) {
									var g = s(t, "position");("fixed" === g || "absolute" === g && /top|left/i.test(n)) && (l = h(t).position()[n] + "px");
								}return l;
							}var l;if (w.Hooks.registered[n]) {
								var u = n,
								    d = w.Hooks.getRoot(u);a === i && (a = w.getPropertyValue(t, w.Names.prefixCheck(d)[0])), w.Normalizations.registered[d] && (a = w.Normalizations.registered[d]("extract", t, a)), l = w.Hooks.extractValue(u, a);
							} else if (w.Normalizations.registered[n]) {
								var c, p;c = w.Normalizations.registered[n]("name", t), "transform" !== c && (p = s(t, w.Names.prefixCheck(c)[0]), w.Values.isCSSNullValue(p) && w.Hooks.templates[n] && (p = w.Hooks.templates[n][1])), l = w.Normalizations.registered[n]("extract", t, p);
							}if (!/^[\d-]/.test(l)) if (o(t) && o(t).isSVG && w.Names.SVGAttribute(n)) {
								if (/^(height|width)$/i.test(n)) try {
									l = t.getBBox()[n];
								} catch (t) {
									l = 0;
								} else l = t.getAttribute(n);
							} else l = s(t, w.Names.prefixCheck(n)[0]);return w.Values.isCSSNullValue(l) && (l = 0), y.debug >= 2 && console.log("Get " + n + ": " + l), l;
						}, setPropertyValue: function setPropertyValue(t, n, i, a, r) {
							var s = n;if ("scroll" === n) r.container ? r.container["scroll" + r.direction] = i : "Left" === r.direction ? e.scrollTo(i, r.alternateValue) : e.scrollTo(r.alternateValue, i);else if (w.Normalizations.registered[n] && "transform" === w.Normalizations.registered[n]("name", t)) w.Normalizations.registered[n]("inject", t, i), s = "transform", i = o(t).transformCache[n];else {
								if (w.Hooks.registered[n]) {
									var l = n,
									    u = w.Hooks.getRoot(n);a = a || w.getPropertyValue(t, u), i = w.Hooks.injectValue(l, i, a), n = u;
								...
								} else o(t) && o(t).isSVG && w.Names.SVGAttribute(n) ? t.setAttribute(n, i) : t.style[s] = i;y.debug >= 2 && console.log("Set " + n + " (" + s + "): " + i);
							}return [s, i];
						}, flushTransformCache: function flushTransformCache(t) {
							function e(e) {
								return parseFloat(w.getPropertyValue(t, e));
							}var n = "";if ((f || y.State.isAndroid && !y.State.isChrome) && o(t).isSVG) {
								var i = { translate: [e("translateX"), e("translateY")], skewX: [e("skewX")], skewY: [e("skewY")], scale: 1 !== e("scale") ? [e("scale"), e("scale")] : [e("scaleX"), e("scaleY")], rotate: [e("rotateZ"), 0, 0] };h.each(o(t).transformCache, function (t) {
									/^translate/i.test(t) ? t = "translate" : /^scale/i.test(t) ? t = "scale" : /^rotate/i.test(t) && (t = "rotate"), i[t] && (n += t + "(" + i[t].join(" ") + ") ", delete i[t]);
								});
							} else {
								var a, r;h.each(o(t).transformCache, function (e) {
						...
						var a = i;return t = r(t), h.each(t, function (t, r) {
							if (o(r) === i && y.init(r), n === i) a === i && (a = y.CSS.getPropertyValue(r, e));else {
								var s = y.CSS.setPropertyValue(r, e, n);"transform" === s[0] && y.CSS.flushTransformCache(r), a = s;
							}
						}), a;
					};var k = function k() {
						function t() {
							...
							function t(t) {
								function c(t, e) {
									...
									var v,
									    x,
									    k,
									    M = /^x$/i.test(s.axis) ? "Left" : "Top",
									    P = parseFloat(s.offset) || 0;s.container ? g.isWrapped(s.container) || g.isNode(s.container) ? (s.container = s.container[0] || s.container, v = s.container["scroll" + M], k = v + h(r).position()[M.toLowerCase()] + P) : s.container = null : (v = y.State.scrollAnchor[y.State["scrollProperty" + M]], x = y.State.scrollAnchor[y.State["scrollProperty" + ("Left" === M ? "Top" : "Left")]], k = h(r).offset()[M.toLowerCase()] + P), l = { scroll: { rootPropertyValue: !1, startValue: v, currentValue: v, endValue: k, unitType: "", easing: s.easing, scrollData: { container: s.container, direction: M, alternateValue: x } }, element: r }, y.debug && console.log("tweensContainer (scroll): ", l.scroll, r);
								} else if ("reverse" === I) {
									if (!o(r).tweensContainer) return void h.dequeue(r, s.queue);"none" === o(r).opts.display && (o(r).opts.display = "auto"), "hidden" === o(r).opts.visibility && (o(r).opts.visibility = "visible"), o(r).opts.loop = !1, o(r).opts.begin = null, o(r).opts.complete = null, b.easing || delete s.easing, b.duration || delete s.duration, s = h.extend({}, o(r).opts, s);var _ = h.extend(!0, {}, o(r).tweensContainer);for (var T in _) {
										if ("element" !== T) {
											var D = _[T].startValue;_[T].startValue = _[T].currentValue = _[T].endValue, _[T].endValue = D, g.isEmptyObject(b) || (_[T].easing = s.easing), y.debug && console.log("reverse tweensContainer (" + T + "): " + JSON.stringify(_[T]), r);
										}
									}l = _;
								} else if ("start" === I) {
									var _;o(r).tweensContainer && o(r).isAnimating === !0 && (_ = o(r).tweensContainer), h.each(m, function (t, e) {
										if (RegExp("^" + w.Lists.colors.join("$|^") + "$").test(t)) {
											var n = c(e, !0),
											    a = n[0],
											    r = n[1],
											    o = n[2];if (w.RegEx.isHex.test(a)) {
												for (var s = ["Red", "Green", "Blue"], l = w.Values.hexToRgb(a), u = o ? w.Values.hexToRgb(o) : i, d = 0; d < s.length; d++) {
													var h = [l[d]];r && h.push(r), u !== i && h.push(u[d]), m[t + s[d]] = h;
												}delete m[t];
											}
										}
									});for (var V in m) {
										var F = c(m[V]),
										    R = F[0],
										    W = F[1],
										    E = F[2];V = w.Names.camelCase(V);var B = w.Hooks.getRoot(V),
										    z = !1;if (o(r).isSVG || "tween" === B || w.Names.prefixCheck(B)[1] !== !1 || w.Normalizations.registered[B] !== i) {
											(s.display !== i && null !== s.display && "none" !== s.display || s.visibility !== i && "hidden" !== s.visibility) && /opacity|filter/.test(V) && !E && 0 !== R && (E = 0), s._cacheValues && _ && _[V] ? (E === i && (E = _[V].endValue + _[V].unitType), z = o(r).rootPropertyValueCache[B]) : w.Hooks.registered[V] ? E === i ? (z = w.getPropertyValue(r, B), E = w.getPropertyValue(r, V, z)) : z = w.Hooks.templates[B][1] : E === i && (E = w.getPropertyValue(r, V));var N,
											    H,
											    j,
											    q = !1;if (N = f(V, E), E = N[0], j = N[1], N = f(V, R), R = N[0].replace(/^([+-\/*])=/, function (t, e) {
												return q = e, "";
											}), H = N[1], E = parseFloat(E) || 0, R = parseFloat(R) || 0, "%" === H && (/^(fontSize|lineHeight)$/.test(V) ? (R /= 100, H = "em") : /^scale/.test(V) ? (R /= 100, H = "") : /(Red|Green|Blue)$/i.test(V) && (R = R / 100 * 255, H = "")), /[\/*]/.test(q)) H = j;else if (j !== H && 0 !== E) if (0 === R) H = j;else {
												a = a || function () {
													var t = { myParent: r.parentNode || n.body, position: w.getPropertyValue(r, "position"), fontSize: w.getPropertyValue(r, "fontSize") },
													    ...
													    l = {};if (a && i) l.emToPx = L.lastEmToPx, l.percentToPxWidth = L.lastPercentToPxWidth, l.percentToPxHeight = L.lastPercentToPxHeight;else {
														var u = o(r).isSVG ? n.createElementNS("http://www.w3.org/2000/svg", "rect") : n.createElement("div");y.init(u), t.myParent.appendChild(u), h.each(["overflow", "overflowX", "overflowY"], function (t, e) {
												...
												}();var Y = /margin|padding|left|right|width|text|word|letter/i.test(V) || /X$/.test(V) || "x" === V ? "x" : "y";switch (j) {case "%":
														E *= "x" === Y ? a.percentToPxWidth : a.percentToPxHeight;break;case "px":
														break;default:
														E *= a[j + "ToPx"];}switch (H) {case "%":
														E *= 1 / ("x" === Y ? a.percentToPxWidth : a.percentToPxHeight);break;case "px":
														break;default:
														E *= 1 / a[H + "ToPx"];}
											}switch (q) {case "+":
													R = E + R;break;case "-":
													R = E - R;break;case "*":
													R *= E;break;case "/":
													R = E / R;}l[V] = { rootPropertyValue: z, startValue: E, currentValue: E, endValue: R, unitType: H, easing: W }, y.debug && console.log("tweensContainer (" + V + "): " + JSON.stringify(l[V]), r);
							    ...
							    l = {};switch (o(r) === i && y.init(r), parseFloat(s.delay) && s.queue !== !1 && h.queue(r, s.queue, function (t) {
								y.velocityQueueEntryFlag = !0, o(r).delayTimer = { setTimeout: setTimeout(t, parseFloat(s.delay)), next: t };
						    ...
						    m,
						    b,
						    x = arguments[0] && (arguments[0].p || h.isPlainObject(arguments[0].properties) && !arguments[0].properties.names || g.isString(arguments[0].properties));if (g.isWrapped(this) ? (s = !1, f = 0, p = this, l = this) : (s = !0, f = 1, p = x ? arguments[0].elements || arguments[0].e : arguments[0]), p = r(p)) {
							x ? (m = arguments[0].properties || arguments[0].p, b = arguments[0].options || arguments[0].o) : (m = arguments[f], b = arguments[f + 1]);var S = p.length,
							    C = 0;if (!/^(stop|finish)$/i.test(m) && !h.isPlainObject(b)) {
								var M = f + 1;b = {};for (var P = M; P < arguments.length; P++) {
									g.isArray(arguments[P]) || !/^(fast|normal|slow)$/i.test(arguments[P]) && !/^\d/.test(arguments[P]) ? g.isString(arguments[P]) || g.isArray(arguments[P]) ? b.easing = arguments[P] : g.isFunction(arguments[P]) && (b.complete = arguments[P]) : b.duration = arguments[P];
								}
							}var A = { promise: null, resolver: null, rejecter: null };s && y.Promise && (A.promise = new y.Promise(function (t, e) {
								A.resolver = t, A.rejecter = e;
							}));var I;switch (m) {case "scroll":
									I = "scroll";break;case "reverse":
									I = "reverse";break;case "finish":case "stop":
									...
									});var _ = [];return h.each(y.State.calls, function (t, e) {
										e && h.each(e[1], function (n, a) {
											var r = b === i ? "" : b;return r !== !0 && e[2].queue !== r && (b !== i || e[2].queue !== !1) || void h.each(p, function (n, i) {
									...
									if (!h.isPlainObject(m) || g.isEmptyObject(m)) {
										if (g.isString(m) && y.Redirects[m]) {
											var T = h.extend({}, b),
											    D = T.duration,
											    V = T.delay || 0;return T.backwards === !0 && (p = h.extend(!0, [], p).reverse()), h.each(p, function (t, e) {
										...
										}var F = "Velocity: First argument (" + m + ") was not a property map, a known action, or a registered redirect. Aborting.";return A.promise ? A.rejecter(new Error(F)) : console.log(F), t();
									}I = "start";}var L = { lastParent: null, lastPosition: null, lastFontSize: null, lastPercentToPxWidth: null, lastPercentToPxHeight: null, lastEmToPx: null, remToPx: null, vwToPx: null, vhToPx: null },
							    O = [];h.each(p, function (t, e) {
								g.isNode(e) && a.call(e);
							});var R,
							    T = h.extend({}, y.defaults, b);if (T.loop = parseInt(T.loop), R = 2 * T.loop - 1, T.loop) for (var W = 0; R > W; W++) {
								var E = { delay: T.delay, progress: T.progress };W === R - 1 && (E.display = T.display, E.visibility = T.visibility, E.complete = T.complete), k(p, "reverse", E);
							}return t();
						}
					};y = h.extend(k, y), y.animate = k;var S = e.requestAnimationFrame || p;return y.State.isMobile || n.hidden === i || n.addEventListener("visibilitychange", function () {
						n.hidden ? (S = function S(t) {
						...
						y.Redirects["slide" + e] = function (t, n, a, r, o, s) {
							var l = h.extend({}, n),
							    ...
							    f = {};l.display === i && (l.display = "Down" === e ? "inline" === y.CSS.Values.getDisplayType(t) ? "inline-block" : "block" : "none"), l.begin = function () {
								u && u.call(o, o);for (var n in c) {
									f[n] = t.style[n];var i = y.CSS.getPropertyValue(t, n);c[n] = "Down" === e ? [i, 0] : [0, i];
						...
						y.Redirects["fade" + e] = function (t, n, a, r, o, s) {
							var l = h.extend({}, n),
							    u = { opacity: "In" === e ? 1 : 0 },
							    d = l.complete;l.complete = a !== r - 1 ? l.begin = null : function () {
								d && d.call(o, o), s && s.resolver(o);
				...
				return function t(e, n, i) {
					function a(o, s) {
						...
						function i(t) {
							...
							if (t) {
								var e = t.match(/^hsla?\(\s*([+-]?\d+)(?:deg)?\s*,\s*([+-]?[\d\.]+)%\s*,\s*([+-]?[\d\.]+)%\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)/);if (e) {
									var n = parseFloat(e[4]);return [b(parseInt(e[1]), 0, 360), b(parseFloat(e[2]), 0, 100), b(parseFloat(e[3]), 0, 100), b(isNaN(n) ? 1 : n, 0, 1)];
								}
							}
						}function r(t) {
							if (t) {
						...
						}var x = t(6);e.exports = { getRgba: i, getHsla: a, getRgb: o, getHsl: s, getHwb: r, getAlpha: l, hexString: u, rgbString: d, rgbaString: c, percentString: h, percentaString: f, hslString: p, hslaString: g, hwbString: m, keyword: v };var w = {};for (var k in x) {
							w[x[k]] = k;
						}
						...
						e.exports = function (t) {
							var e = t.helpers;t.defaults.bar = { hover: { mode: "label" }, scales: { xAxes: [{ type: "category", categoryPercentage: .8, barPercentage: .9, gridLines: { offsetGridLines: !0 } }], yAxes: [{ type: "linear" }] } }, t.controllers.bar = t.DatasetController.extend({ dataElementType: t.elements.Rectangle, initialize: function initialize() {
									...
									var a = this,
									    ...
									    s = a.getDataset(),
									    l = t.custom || {},
									    u = r.options.elements.rectangle;t._xScale = a.getScaleForId(o.xAxisID), t._yScale = a.getScaleForId(o.yAxisID), t._datasetIndex = a.index, t._index = n, t._model = { datasetLabel: s.label, label: r.data.labels[n], borderSkipped: l.borderSkipped ? l.borderSkipped : u.borderSkipped,
									...
									var n,
									    ...
									    p = c.options.stacked,
									    g = d.stack,
									    m = 0;if (p || void 0 === p && void 0 !== g) for (n = 0; n < t; ++n) {
										i = u.getDatasetMeta(n), i.bar && i.stack === g && i.controller.getValueScaleId() === c.id && u.isDatasetVisible(n) && (a = Number(h[n].data[e]), (f < 0 && a < 0 || f >= 0 && a > 0) && (m += a));
									...
									var t,
										...
										null === (t = r.data[s]) || void 0 === t || isNaN(t) || a[s].draw();
						...
						e.exports = function (t) {
							var e = t.helpers;t.defaults.bubble = { hover: { mode: "single" }, scales: { xAxes: [{ type: "linear", position: "bottom", id: "x-axis-0" }], yAxes: [{ type: "linear", position: "left", id: "y-axis-0" }] }, tooltips: { callbacks: { title: function title() {
									...
									var i = this;t.DatasetController.prototype.setHoverStyle.call(i, n);var a = i.chart.data.datasets[n._datasetIndex],
									    r = n._index,
									    o = n.custom || {};n._model.radius = o.hoverRadius ? o.hoverRadius : e.getValueAtIndexOrDefault(a.hoverRadius, r, i.chart.options.elements.point.hoverRadius) + i.getRadius(a.data[r]);
									...
									var n = this;t.DatasetController.prototype.removeHoverStyle.call(n, e, n.chart.options.elements.point);var i = n.chart.data.datasets[e._datasetIndex].data[e._index],
									    a = e.custom || {};e._model.radius = a.radius ? a.radius : n.getRadius(i);
								} });
						};
					}, {}], 17: [function (t, e, n) {
						"use strict";
							...
							var e = t.helpers,
							    n = t.defaults;n.doughnut = { animation: { animateRotate: !0, animateScale: !1 }, aspectRatio: 1, hover: { mode: "single" }, legendCallback: function legendCallback(t) {
									...
									var n = this,
										...
										var p = r.rotation % (2 * Math.PI);p += 2 * Math.PI * (p >= Math.PI ? -1 : p < -Math.PI ? 1 : 0);var g = p + f,
										    ...
										    M = { width: .5 * (C.x - S.x), height: .5 * (C.y - S.y) };u = Math.min(s / M.width, l / M.height), d = { x: (C.x + S.x) * -.5, y: (C.y + S.y) * -.5 };
						...
						e.exports = function (t) {
							function e(t, e) {
								return n.getValueOrDefault(t.showLine, e.showLines);
									...
									}for (p && 0 !== l._model.tension && o.updateBezierControlPoints(), i = 0, a = u.length; i < a; ++i) {
										u[i].pivot();
									}
						...
						e.exports = function (t) {
							var e = t.helpers;t.defaults.polarArea = { scale: { type: "radialLinear", angleLines: { display: !1 }, gridLines: { circular: !0 }, pointLabels: { display: !1 }, ticks: { beginAtZero: !0 } }, animation: { animateRotate: !0, animateScale: !0 }, startAngle: -.5 * Math.PI, aspectRatio: 1, legendCallback: function legendCallback(t) {
									...
									for (var a = this, r = a.chart, o = a.getDataset(), s = r.options, l = s.animation, u = r.scale, d = e.getValueAtIndexOrDefault, c = r.data.labels, h = a.calculateCircumference(o.data[n]), f = u.xCenter, p = u.yCenter, g = 0, m = a.getMeta(), v = 0; v < n; ++v) {
										isNaN(o.data[v]) || m.data[v].hidden || ++g;
									}var b = s.startAngle,
									    y = t.hidden ? 0 : u.getDistanceFromCenterForValue(o.data[n]),
									    x = b + h * g,
									    w = x + (t.hidden ? 0 : h),
									    k = l.animateScale ? 0 : u.getDistanceFromCenterForValue(o.data[n]);e.extend(t, { _datasetIndex: a.index, _index: n, _scale: u, _model: { x: f, y: p, innerRadius: 0, outerRadius: i ? k : y, startAngle: i && l.animateRotate ? b : x, endAngle: i && l.animateRotate ? b : w, label: d(c, n, c[n]) } }), a.removeHoverStyle(t), t.pivot();
								}, removeHoverStyle: function removeHoverStyle(e) {
									t.DatasetController.prototype.removeHoverStyle.call(this, e, this.chart.options.elements.arc);
						...
						e.exports = function (t) {
							var e = t.canvasHelpers = {};e.drawPoint = function (e, n, i, a, r) {
								var o, s, l, u, d, c;if ("object" == (typeof n === 'undefined' ? 'undefined' : _typeof(n)) && ("[object HTMLImageElement]" === (o = n.toString()) || "[object HTMLCanvasElement]" === o)) return void e.drawImage(n, a - n.width / 2, r - n.height / 2, n.width, n.height);if (!(isNaN(i) || i <= 0)) {
									switch (n) {default:
											...
											var h = i / Math.SQRT2,
											    f = a - h,
											    p = r - h,
											    g = Math.SQRT2 * i;t.helpers.drawRoundedRectangle(e, f, p, g, g, i / 2), e.fill();break;case "rectRot":
							...
							function e(e) {
							    ...
							    o = t.platform;t.types = {}, t.instances = {}, t.controllers = {}, a.extend(t.prototype, { construct: function construct(n, i) {
									var r = this;i = e(i);var s = o.acquireContext(n, i),
									    l = s && s.canvas,
									    u = l && l.height,
									    d = l && l.width;if (r.id = a.uid(), r.ctx = s, r.canvas = l, r.config = i, r.width = d, r.height = u, r.aspectRatio = u ? d / u : null, r.options = i.options, r._bufferedRender = !1, r.chart = r, r.controller = r, t.instances[r.id] = r, Object.defineProperty(r, "data", { get: function get() {
											return r.config.data;
										}, set: function set(t) {
											r.config.data = t;
										} }), !s || !l) return void console.error("Failed to create chart: can't acquire context from the given item");r.initialize(), r.update();
						...
						e.exports = function (t) {
							function e(t, e) {
								if (t._chartjs) return void t._chartjs.listeners.push(e);Object.defineProperty(t, "_chartjs", { configurable: !0, enumerable: !1, value: { listeners: [e] } }), a.forEach(function (e) {
						...
						var i = t(3);e.exports = function (t) {
							function e(t, e, n, a) {
								var r,
								    ...
								    h,
								    f,
								    p = Object.keys(n);for (r = 0, o = p.length; r < o; ++r) {
						...
						var i = t(3);e.exports = function (t) {
							function e(t, e, n) {
								...
								var e = {};return r.each(t, function (t, n) {
									r.isArray(t) ? e[n] = t.slice(0) : e[n] = "object" == (typeof t === 'undefined' ? 'undefined' : _typeof(t)) && null !== t ? r.clone(t) : t;
								}), e;
							}, r.extend = function (t) {
								...
								var n,
								    ...
								    p = s.bottom - s.top - d - h;return n = Math.round((n - s.left - u) / f * o.width / e.currentDevicePixelRatio), i = Math.round((i - s.top - d) / p * o.height / e.currentDevicePixelRatio), { x: n, y: i };
						...
						e.exports = function (t) {
							function e(t, e) {
								...
								t.forEach(function (t, e) {
									...
									function o(t) {
										var e,
										    n = t.isHorizontal();n ? (e = t.update(t.fullWidth ? w : A, P), I -= e.height) : (e = t.update(M, C), A -= e.width), _.push({ horizontal: n, minSize: e, box: t });
									}function s(t) {
										var e = i.findNextWhere(_, function (e) {
											return e.box === t;
										});if (e) if (t.isHorizontal()) {
											var n = { left: Math.max(L, T), right: Math.max(O, D), top: 0, bottom: 0 };t.update(t.fullWidth ? w : A, k / 2, n);
										} else t.update(e.minSize.width, I);
									}function l(t) {
										var e = i.findNextWhere(_, function (e) {
											return e.box === t;
										}),
										    n = { left: 0, right: 0, top: R, bottom: W };e && t.update(e.minSize.width, I, n);
									}function u(t) {
										...
										var d = t.options.layout,
										    ...
										    f = 0,
										    p = 0,
										    g = 0;isNaN(c) ? (h = c.left || 0, f = c.right || 0, p = c.top || 0, g = c.bottom || 0) : (h = c, f = c, p = c, g = c);var m = e(t.boxes, "left"),
										    v = e(t.boxes, "right"),
										    b = e(t.boxes, "top"),
										    y = e(t.boxes, "bottom"),
										    x = e(t.boxes, "chartArea");n(m, !0), n(v, !1), n(b, !0), n(y, !1);var w = a - h - f,
										    k = r - p - g,
										    S = w / 2,
										    C = k / 2,
										    ...
										    A = w,
										    I = k,
										    _ = [];i.each(m.concat(v, b, y), o);var T = 0,
										    D = 0,
										    V = 0,
										    F = 0;i.each(b.concat(y), function (t) {
											if (t.getPadding) {
												var e = t.getPadding();T = Math.max(T, e.left), D = Math.max(D, e.right);
											}
										}), i.each(m.concat(v), function (t) {
											if (t.getPadding) {
												var e = t.getPadding();V = Math.max(V, e.top), F = Math.max(F, e.bottom);
											}
										});var L = h,
										    O = f,
										    R = p,
										    W = g;i.each(m.concat(v), s), i.each(m, function (t) {
											L += t.width;
										}), i.each(v, function (t) {
											O += t.width;
											...
											W += t.height;
										});var E = Math.max(T - L, 0);L += E, O += Math.max(D - O, 0);var B = Math.max(V - R, 0);R += B, W += Math.max(F - W, 0);var z = r - R - W,
										    N = a - L - O;N === A && z === I || (i.each(m, function (t) {
											t.height = z;
										}), i.each(v, function (t) {
											t.height = z;
										}), i.each(b, function (t) {
										    ...
										    j = p + B;i.each(m.concat(b), u), H += A, j += I, i.each(v, u), i.each(y, u), t.chartArea = { left: L, top: R, right: L + A, bottom: R + I }, i.each(x, function (e) {
						...
						e.exports = function (t) {
							var e = t.helpers;t.defaults.global.plugins = {}, t.plugins = { _plugins: [], _cacheId: 0, register: function register(t) {
									...
									var i = n._plugins || (n._plugins = {});if (i.id === this._cacheId) return i.descriptors;var a = [],
										...
										if (a.indexOf(t) === -1) {
											var n = t.id,
											    i = l[n];i !== !1 && (i === !0 && (i = e.clone(s[n])), a.push(t), r.push({ plugin: t, options: i || {} }));
										}
							...
							function e(t, e, n) {
								...
								var n = i.getValueOrDefault,
									...
									var t = this,
									    e = t.ctx,
									    a = t.options.ticks,
									    r = n(a);e.font = r.font;var o = a.minRotation || 0;if (t.options.display && t.isHorizontal()) for (var s, l = i.longestText(e, r.font, t.ticks, t.longestTextCache), u = l, d = t.getPixelForTick(1) - t.getPixelForTick(0) - 6; u > d && o < a.maxRotation;) {
										var c = i.toRadians(o);if (s = Math.cos(c), Math.sin(c) * l > t.maxHeight) {
											o--;break;
										}o++, u = s * l;
									}t.labelRotation = o;
									...
									var t = this,
										...
										var p = i.longestText(t.ctx, c.font, t.ticks, t.longestTextCache),
										    ...
										    m = .5 * c.size;if (d) {
											t.longestLabelWidth = p;var v = i.toRadians(t.labelRotation),
											    b = Math.cos(v),
											    y = Math.sin(v),
											    x = y * p + c.size * g + m * g;a.height = Math.min(t.maxHeight, a.height + x), t.ctx.font = c.font;var w = t.ticks[0],
											    k = e(t.ctx, w, c.font),
											    S = t.ticks[t.ticks.length - 1],
											    C = e(t.ctx, S, c.font);0 !== t.labelRotation ? (t.paddingLeft = "bottom" === r.position ? b * k + 3 : b * m + 3, t.paddingRight = "bottom" === r.position ? b * m + 3 : b * C + 3) : (t.paddingLeft = k / 2 + 3, t.paddingRight = C / 2 + 3);
									...
									var a = this,
										...
										var o,
										    ...
										    f = 0 !== a.labelRotation,
										    p = d.autoSkip,
										    g = a.isHorizontal();d.maxTicksLimit && (s = d.maxTicksLimit);var m = i.getValueOrDefault(d.fontColor, u.defaultFontColor),
										    v = n(d),
										    ...
										    k = Math.cos(w),
										    S = a.longestLabelWidth * k;l.fillStyle = m;var C = [];if (g) {
											if (o = !1, (S + d.autoSkipPadding) * a.ticks.length > a.width - (a.paddingLeft + a.paddingRight) && (o = 1 + Math.floor((S + d.autoSkipPadding) * a.ticks.length / (a.width - (a.paddingLeft + a.paddingRight)))), s && a.ticks.length > s) for (; !o || a.ticks.length / (o || 1) > s;) {
												o || (o = 1), o += 1;
											}p || (o = !1);
										}var M = "right" === r.position ? a.left : a.right - b,
										    P = "right" === r.position ? a.left + b : a.right,
										    A = "bottom" === r.position ? a.top : a.bottom - b,
										    I = "bottom" === r.position ? a.top + b : a.bottom;if (i.each(a.ticks, function (t, n) {
											if (void 0 !== t && null !== t) {
												var s = a.ticks.length === n + 1;if ((!(o > 1 && n % o > 0 || n % o == 0 && n + o >= a.ticks.length) || s) && void 0 !== t && null !== t) {
													var l, h, p, m;n === (void 0 !== a.zeroLineIndex ? a.zeroLineIndex : 0) ? (l = c.zeroLineWidth, h = c.zeroLineColor, p = c.zeroLineBorderDash, m = c.zeroLineBorderDashOffset) : (l = i.getValueAtIndexOrDefault(c.lineWidth, n), h = i.getValueAtIndexOrDefault(c.color, n), p = i.getValueOrDefault(c.borderDash, u.borderDash), m = i.getValueOrDefault(c.borderDashOffset, u.borderDashOffset));var v,
													    y,
													    x,
													    k,
													    S,
													    ...
													    L = "middle",
													    O = "middle";if (g) {
														"bottom" === r.position ? (O = f ? "middle" : "top", L = f ? "right" : "center", F = a.top + b) : (O = f ? "middle" : "bottom", L = f ? "left" : "center", F = a.bottom - b);var R = a.getPixelForTick(n) + i.aliasPixel(l);V = a.getPixelForTick(n, c.offsetGridLines) + d.labelOffset, v = x = S = T = R, y = A, k = I, _ = e.top, D = e.bottom;
													} else {
														var W,
														    E = "left" === r.position,
														    B = d.padding;d.mirror ? (L = E ? "left" : "right", W = B) : (L = E ? "right" : "left", W = b + B), V = E ? a.right - W : a.left + W;var z = a.getPixelForTick(n);z += i.aliasPixel(l), F = a.getPixelForTick(n, c.offsetGridLines), v = M, x = P, S = e.left, T = e.right, y = k = _ = D = z;
													}C.push({ tx1: v, ty1: y, tx2: x, ty2: k, x1: S, y1: _, x2: T, y2: D, labelX: V, labelY: F, glWidth: l, glColor: h, glBorderDash: p, glBorderDashOffset: m, rotation: -1 * w, label: t, textBaseline: O, textAlign: L });
												}
											}
										}), i.each(C, function (t) {
											...
											var _,
											    T,
											    D = 0;if (g) _ = a.left + (a.right - a.left) / 2, T = "bottom" === r.position ? a.bottom - x.size / 2 : a.top + x.size / 2;else {
												var V = "left" === r.position;_ = V ? a.left + x.size / 2 : a.right - x.size / 2, T = a.top + (a.bottom - a.top) / 2, D = V ? -.5 * Math.PI : .5 * Math.PI;
											...
											l.lineWidth = i.getValueAtIndexOrDefault(c.lineWidth, 0), l.strokeStyle = i.getValueAtIndexOrDefault(c.color, 0);var F = a.left,
											    L = a.right,
											    O = a.top,
											    R = a.bottom,
											    W = i.aliasPixel(l.lineWidth);g ? (O = R = "top" === r.position ? a.bottom : a.top, O += W, R += W) : (F = L = "left" === r.position ? a.right : a.left, F += W, L += W), l.beginPath(), l.moveTo(F, O), l.lineTo(L, R), l.stroke();
										}
									}
								} });
						};
						...
						e.exports = function (t) {
							function e(t, e) {
								...
								}), f = 0, n.font = l.fontString(h, e._footerFontStyle, e._footerFontFamily), l.each(e.footer, p), a += 2 * e.xPadding, { width: a, height: i };
							}function o(t, e) {
								var n = t._model,
								    i = t._chart,
								...
								}, s(n.x) ? (r = "left", u(n.x) && (r = "center", o = c(n.y))) : l(n.x) && (r = "right", d(n.x) && (r = "center", o = c(n.y)));var p = t._options;return { xAlign: p.xAlign ? p.xAlign : r, yAlign: p.yAlign ? p.yAlign : o };
							}function s(t, e, n) {
								var i = t.x,
								    a = t.y,
								    r = t.caretSize,
									...
									var n,
									    ...
									    y = { x: h.caretX, y: h.caretY };if (p.length) {
										f.opacity = 1;var x = [];y = t.Tooltip.positioners[c.position](p, d._eventPosition);var w = [];for (n = 0, u = p.length; n < u; ++n) {
											w.push(i(p[n]));
									...
									} else f.opacity = 0;return f.xAlign = m.xAlign, f.yAlign = m.yAlign, f.x = v.x, f.y = v.y, f.width = b.width, f.height = b.height, f.caretX = y.x, f.caretY = y.y, d._model = f, e && c.custom && c.custom.call(d, f), d;
									...
									var i,
									    ...
									    p = t.y,
									    g = e.width,
									    m = e.height;if ("center" === h) s = p + m / 2, "left" === c ? (i = f, a = i - u, r = i, o = s + u, l = s - u) : (i = f + g, a = i + u, r = i, o = s - u, l = s + u);else if ("left" === c ? (a = f + d + u, i = a - u, r = a + u) : "right" === c ? (a = f + g - d - u, i = a - u, r = a + u) : (a = f + g / 2, i = a - u, r = a + u), "top" === h) o = p, s = o - u, l = o;else {
										o = p + m, s = o + u, l = o;var v = r;r = i, i = v;
							...
							function e(t) {
								...
								var n,
									...
									function t(t) {
									    ...
									    y = b.indexOf(s, 0);y === -1 && (y = 0);var x = t(0);l.moveTo(x[0], x[1]);for (var w = 1; w < 4; w++) {
									...
									var a = this;if (!a._view) return !1;var r = n(a);return e(a) ? t >= r.left && t <= r.right : i >= r.top && i <= r.bottom;
						...
						e.exports = function (t) {
							function e(t, e) {
							    ...
							    u = { touchstart: "mousedown", touchmove: "mousemove", touchend: "mouseup", pointerenter: "mouseenter", pointerdown: "mousedown", pointermove: "mousemove", pointerup: "mouseup", pointerleave: "mouseout", pointerout: "mouseout" };return { acquireContext: function acquireContext(t, e) {
									...
									var i = t.canvas;if ("resize" === e) return void s(i.parentNode);var a = n._chartjs || {},
									    r = a.proxies || {},
						...
						e.exports = function (t) {
							function e(t, e, n) {
								...
								var l,
								    ...
								    b = [],
								    y = 0,
								    x = 0;for (t.beginPath(), l = 0, u = g + !!s; l < u; ++l) {
									d = l % g, c = e[d]._view, h = n(c, d, i), f = r(c), p = r(h), f && p ? (y = v.push(c), x = b.push(h)) : y && x && (m ? (f && v.push(c), p && b.push(h)) : (o(t, v, b, y, x), y = x = 0, v = [], b = []));
							    ...
							    d = { dataset: function dataset(t) {
									...
									var s,
										...
										(d = f[l]) && (d.fill = i(f, l, h), d.boundary = n(d), d.mapper = a(d));
									}
						...
						e.exports = function (t) {
							function e(t, e) {
								...
								var i = new t.Legend({ ctx: e.ctx, options: n,
									chart: e });a.configure(e, i, n), a.addBox(e, i), e.legend = i;
							}var i = t.helpers,
							    a = t.layoutService,
							    r = i.noop;return t.defaults.global.legend = { display: !0, position: "top", fullWidth: !0, reverse: !1, weight: 1e3, onClick: function onClick(t, e) {
									...
									var n = this,
									    ...
									    p = n.legendHitBoxes = [],
									    g = n.minSize,
									    m = n.isHorizontal();if (m ? (g.width = n.maxWidth, g.height = o ? 10 : 0) : (g.width = o ? 10 : 0, g.height = n.maxHeight), o) if (s.font = f, m) {
										var v = n.lineWidths = [0],
										    b = n.legendItems.length ? d + r.padding : 0;s.textAlign = "left", s.textBaseline = "top", i.each(n.legendItems, function (t, i) {
											var a = e(r, d),
											    o = a + d / 2 + s.measureText(t.text).width;v[v.length - 1] + o + r.padding >= n.width && (b += d + r.padding, v[v.length] = n.left), p[i] = { left: 0, top: 0, width: o, height: d }, v[v.length - 1] += o + r.padding;
										}), g.height += b;
									} else {
										var y = r.padding,
										    x = n.columnWidths = [],
										    ...
										    k = 0,
										    S = 0,
										    C = d + y;i.each(n.legendItems, function (t, n) {
											var i = e(r, d),
											    a = i + d / 2 + s.measureText(t.text).width;S + C > g.height && (w += k + r.padding, x.push(k), k = 0, S = 0), k = Math.max(k, a), S += C, p[n] = { left: 0, top: 0, width: a, height: d };
									...
									var n = this,
										...
										var d,
										    ...
										    v = i.fontString(p, g, m);c.textAlign = "left", c.textBaseline = "top", c.lineWidth = .5, c.strokeStyle = f, c.fillStyle = f, c.font = v;var b = e(r, p),
										    y = n.legendHitBoxes,
										    x = function x(e, n, i) {
											if (!(isNaN(b) || b <= 0)) {
												...
												} else r || c.strokeRect(e, n, b, p), c.fillRect(e, n, b, p);c.restore();
											}
										},
										    ...
										    k = n.isHorizontal();d = k ? { x: n.left + (l - u[0]) / 2, y: n.top + r.padding, line: 0 } : { x: n.left + r.padding, y: n.top + r.padding, line: 0 };var S = p + r.padding;i.each(n.legendItems, function (t, e) {
											var i = c.measureText(t.text).width,
											    a = b + p / 2 + i,
											    o = d.x,
											    s = d.y;k ? o + a >= l && (s = d.y += S, d.line++, o = d.x = n.left + (l - u[d.line]) / 2) : s + S > n.bottom && (o = d.x = o + n.columnWidths[d.line] + r.padding, s = d.y = n.top + r.padding, d.line++), x(o, s, t), y[e].left = o, y[e].top = s, w(o, s, t, i), k ? d.x += a + r.padding : d.y += S;
										});
									}
								}, handleEvent: function handleEvent(t) {
									var e = this,
							    ...
							    a = n.noop;return t.defaults.global.title = { display: !1, position: "top", fullWidth: !0, weight: 2e3, fontStyle: "bold", padding: 10, text: "" }, t.Title = t.Element.extend({ initialize: function initialize(t) {
									...
									var e = this,
										...
										var s,
										    ...
										    m = e.left,
										    v = e.bottom,
										    b = e.right;i.fillStyle = a(r.fontColor, o.defaultFontColor), i.font = f, e.isHorizontal() ? (s = m + (b - m) / 2, l = g + (v - g) / 2, u = b - m) : (s = "left" === r.position ? m + d / 2 : b - d / 2, l = g + (v - g) / 2, u = v - g, p = Math.PI * ("left" === r.position ? -.5 : .5)), i.save(), i.translate(s, l), i.rotate(p), i.textAlign = "center", i.textBaseline = "middle", i.fillText(r.text, 0, 0, u), i.restore();
									}
							...
							var e = t.helpers,
							    ...
							    i = t.Scale.extend({ getLabels: function getLabels() {
									...
									var e = this,
									    ...
									    i = e.isHorizontal(),
									    a = (i ? e.width : e.height) / n;return t -= i ? e.left : e.top, e.options.gridLines.offsetGridLines && (t -= a / 2), t <= 0 ? 0 : Math.round(t / a);
								}, getBasePixel: function getBasePixel() {
									return this.bottom;
							...
							var e = t.helpers,
							    ...
							    i = t.LinearScaleBase.extend({ determineDataLimits: function determineDataLimits() {
									function t(t) {
									    ...
									    r = a.data,
									    o = r.datasets,
									    s = n.isHorizontal();n.min = null, n.max = null;var l = i.stacked;if (void 0 === l && e.each(o, function (e, n) {
										if (!l) {
											var i = a.getDatasetMeta(n);a.isDatasetVisible(n) && t(i) && void 0 !== i.stack && (l = !0);
										}
									}), i.stacked || l) {
										var u = {};e.each(o, function (r, o) {
											var s = a.getDatasetMeta(o),
											    l = [s.type, void 0 === i.stacked && void 0 === s.stack ? o : "", s.stack].join(".");void 0 === u[l] && (u[l] = { positiveValues: [], negativeValues: [] });var d = u[l].positiveValues,
											    c = u[l].negativeValues;a.isDatasetVisible(o) && t(s) && e.each(r.data, function (t, e) {
												var a = +n.getRightValue(t);isNaN(a) || s.data[e].hidden || (d[e] = d[e] || 0, c[e] = c[e] || 0, i.relativePoints ? d[e] = 100 : a < 0 ? c[e] += a : d[e] += a);
											});
										}), e.each(u, function (t) {
						...
						e.exports = function (t) {
							function e(t) {
								...
								var r,
									...
									s = t.getPointPosition(r, u), o = i(t.ctx, l.size, t.pointLabels[r] || ""), t._pointLabelSizes[r] = o;var p = t.getIndexAngle(r),
									    g = f.toDegrees(p) % 360,
									    m = a(g, s.x, o.w, 0, 180),
									    v = a(g, s.y, o.h, 90, 270);m.start < d.l && (d.l = m.start, c.l = p), m.end > d.r && (d.r = m.end, c.r = p), v.start < d.t && (d.t = v.start, c.t = p), v.end > d.b && (d.b = v.end, c.b = p);
								...
								var i = t.ctx,
								    ...
								    h = n(t);i.textBaseline = "top";for (var g = e(t) - 1; g >= 0; g--) {
									if (o.display) {
										var m = t.getPointPosition(g, c);i.beginPath(), i.moveTo(t.xCenter, t.yCenter), i.lineTo(m.x, m.y), i.stroke(), i.closePath();
									}if (d.display) {
										var v = t.getPointPosition(g, c + 5),
										    b = a(d.fontColor, p.defaultFontColor);i.font = h.font, i.fillStyle = b;var y = t.getIndexAngle(g),
										    x = f.toDegrees(y);i.textAlign = s(x), u(x, t._pointLabelSizes[g], v), l(i, t.pointLabels[g] || "", v, h.size);
									}
								}
							}function c(t, n, i, a) {
							    ...
							    m = t.LinearScaleBase.extend({ setDimensions: function setDimensions() {
									var t = this,
									    ...
									    a = f.getValueOrDefault(n.fontSize, p.defaultFontSize);t.drawingArea = e.display ? i / 2 - (a / 2 + n.backdropPaddingY) : i / 2;
								}, determineDataLimits: function determineDataLimits() {
									var t = this,
									    e = t.chart,
									...
									var t = this.options.ticks,
									    e = f.getValueOrDefault(t.fontSize, p.defaultFontSize);return Math.min(t.maxTicksLimit ? t.maxTicksLimit : 11, Math.ceil(this.drawingArea / (1.5 * e)));
								}, convertTicksToLabels: function convertTicksToLabels() {
										...
										var r = t.ctx,
											...
											if (l > 0 || e.reverse) {
												var d = t.getDistanceFromCenterForValue(t.ticksAsNumbers[l]),
													...
													var f = a(i.fontColor, p.defaultFontColor);if (r.font = u, i.showLabelBackdrop) {
														var g = r.measureText(s).width;r.fillStyle = i.backdropColor, r.fillRect(t.xCenter - g / 2 - i.backdropPaddingX, h - o / 2 - i.backdropPaddingY, g + 2 * i.backdropPaddingX, o + 2 * i.backdropPaddingY);
							...
							function e(t, e) {
								...
								var n,
									...
									var i,
									    ...
									    f = l.unit || n(l.minUnit, i || u, r || d, h);s.displayFormat = l.displayFormats[f];var p = l.stepSize || a(i || u, r || d, f, h);s.ticks = t.Ticks.generators.time({ maxTicks: h, min: i, max: r, stepSize: p, unit: f, isoWeekday: l.isoWeekday }, { min: u, max: d }), s.max = o.max(s.ticks), s.min = o.min(s.ticks);
									...
									var n = this,
									    ...
									    s = Math.sin(o.toRadians(i.maxRotation));return a * r + o.getValueOrDefault(i.fontSize, t.defaults.global.defaultFontSize) * s;
				...
				var e = t.getBoundingClientRect(),
				    ...
				    r = e.top + i - a;return Math.round(r);
				...
				true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function () {
					return e.apply(t);
				}.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : "object" == (typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) ? module.exports = e.call(t) : t.Waves = e.call(t);
				...
				function t(t) {
					...
					var e = h.call(t);return "[object String]" === e ? c(t) : n(t) && /^\[object (Array|HTMLCollection|NodeList|Object)\]$/.test(e) && t.hasOwnProperty("length") ? t : i(t) ? [t] : [];
				}function r(t) {
					var n,
					    i,
					    a = { top: 0, left: 0 },
					...
					if (n) {
						n.classList.remove("waves-rippling");var i = n.getAttribute("data-x"),
						    ...
						    u = 350 - l;u < 0 && (u = 0), "mousemove" === t.type && (u = 150);var d = "mousemove" === t.type ? 2500 : p.duration;setTimeout(function () {
							var t = { top: a + "px", left: i + "px", opacity: "0", "-webkit-transition-duration": d + "ms", "-moz-transition-duration": d + "ms", "-o-transition-duration": d + "ms", "transition-duration": d + "ms", "-webkit-transform": r + " " + s, "-moz-transform": r + " " + s, "-ms-transform": r + " " + s, "-o-transform": r + " " + s, transform: r + " " + s };n.setAttribute("style", o(t)), setTimeout(function () {
								try {
									e.removeChild(n);
								} catch (t) {
									return !1;
					...
					if (m.allowEvent(t) === !1) return null;for (var e = null, n = t.target || t.srcElement; null !== n.parentElement;) {
					...
					var e = l(t);if (null !== e) {
						if (e.disabled || e.getAttribute("disabled") || e.classList.contains("disabled")) return;if (m.registerEvent(t), "touchstart" === t.type && p.delay) {
							var n = !1,
							    i = setTimeout(function () {
								i = null, p.show(t, e);
							}, p.delay),
							    a = function a(_a) {
								i && (clearTimeout(i), i = null, p.show(t, e)), n || (n = !0, p.hide(_a, e));
							},
							    r = function r(t) {
				    ...
				    p = { duration: 750, delay: 200, show: function show(t, e, n) {
						if (2 === t.button) return !1;e = e || this;var i = document.createElement("div");i.className = "waves-ripple waves-rippling", e.appendChild(i);var a = r(e),
						    s = 0,
				    ...
				    m = { touches: 0, allowEvent: function allowEvent(t) {
						var e = !0;return (/^(mousedown|mousemove)$/.test(t.type) && m.touches && (e = !1), e
						);
					}, registerEvent: function registerEvent(t) {
						var e = t.type;"touchstart" === e ? m.touches += 1 : /^(touchend|touchcancel)$/.test(e) && setTimeout(function () {
							m.touches && (m.touches -= 1);
						}, 500);
					} };return d.init = function (t) {
					var e = document.body;t = t || {}, "duration" in t && (p.duration = t.duration), "delay" in t && (p.delay = t.delay), f && (e.addEventListener("touchstart", u, !1), e.addEventListener("touchcancel", m.registerEvent, !1), e.addEventListener("touchend", m.registerEvent, !1)), e.addEventListener("mousedown", u, !1);
				}, d.attach = function (t, e) {
					t = a(t), "[object Array]" === h.call(e) && (e = e.join(" ")), e = e ? " " + e : "";for (var n, i, r = 0, o = t.length; r < o; r++) {
						n = t[r], i = n.tagName.toLowerCase(), ["input", "img"].indexOf(i) !== -1 && (g[i](n), n = n.parentElement), n.className.indexOf("waves-effect") === -1 && (n.className += " waves-effect" + e);
					}
				}, d.ripple = function (t, e) {
					t = a(t);var n = t.length;if (e = e || {}, e.wait = e.wait || 0, e.position = e.position || null, n) for (var i, o, s, l = {}, u = 0, d = { type: "mousedown", button: 1 }; u < n; u++) {
						if (i = t[u], o = e.position || { x: i.clientWidth / 2, y: i.clientHeight / 2 }, s = r(i), l.x = s.left + o.x, l.y = s.top + o.y, d.pageX = l.x, d.pageY = l.y, p.show(d, i), e.wait >= 0 && null !== e.wait) {
							var c = { type: "mouseup", button: 1 };setTimeout(function (t, e) {
								return function () {
									p.hide(t, e);
								};
							}(c, i), e.wait);
					...
					t = a(t);for (var e = { type: "mouseup", button: 1 }, n = 0, i = t.length; n < i; n++) {
						p.hide(e, t[n]);
					}
					...
					var e = ["text", "password", "email", "url", "tel", "number", "search", "search-md"].map(function (t) {
						...
						if (t.hasClass("validate")) {
							var e = t.val(),
								...
								var a = t.is(":valid"),
								    r = +t.attr("length") || 0;a && (!r || r > e.length) ? t.removeClass("invalid").addClass("valid") : t.removeClass("valid").addClass("invalid");
							}
						}
					},
					    a = function a() {
						var e = t(void 0);if (e.val().length) {
							var n = t(".hiddendiv"),
							    i = e.css("font-family"),
							    a = e.css("font-size");a && hiddenDiv.css("font-size", a), i && hiddenDiv.css("font-family", i), "off" === e.attr("wrap") && hiddenDiv.css("overflow-wrap", "normal").css("white-space", "pre"), n.text(e.val() + "\n");var r = hiddenDiv.html().replace(/\n/g, "<br>");n.html(r), n.css("width", e.is(":visible") ? e.width() : t(window).width() / 2), e.css("height", n.height());
						}
						...
						var n = t(e.target),
						    ...
						    o = void 0 === n.attr("placeholder");a && r && o && n.siblings("label, i").removeClass("active"), i(n);
					}), t(document).on("change", e, function (e) {
						var a = t(e.target);n(a), i(a);
						...
						var i = t(n.target);if (i.is("form")) {
							i.find(e).removeClass("valid").removeClass("invalid").each(function (e, n) {
								var i = t(n),
								    a = !i.val(),
								    r = !i.attr("placeholder");a && r && i.siblings("label, i").removeClass("active");
							}), i.find("select.initialized").each(function (e, n) {
								var i = t(n),
								    a = i.siblings("input.select-dropdown"),
								    r = i.children("[selected]").val();i.val(r), a.val(r);
							});
						}
