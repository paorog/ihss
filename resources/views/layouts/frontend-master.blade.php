...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	{{ Html::style(URL::asset('resources/assets/css/animate.css')) }}
	{{ Html::style(URL::asset('resources/assets/css/icomoon.css')) }}
	{{ Html::style(URL::asset('resources/assets/css/bootstrap.css')) }}
	{{ Html::style(URL::asset('resources/assets/css/superfish.css')) }}
	{{ Html::style(URL::asset('resources/assets/css/style.css')) }}
	{{ Html::script(URL::asset('resources/assets/css/modernizr-2.6.2.min.js')) }}
	@yield('stylesheets')
	<!-- FOR IE9 below -->
	<!--[if lt IE 9]>
